      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h2 className="text-3xl font-bold text-gradient bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                RESUMIFY
              </h2>
              <p className="text-gray-300 mt-4 text-lg leading-relaxed max-w-md">
                ...
                Get instant feedback, ATS scores, and personalized recommendations.
              </p>
            </div>
        ...
        <div className="mt-16 pt-12 border-t border-gray-700">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-8">
              Get the latest tips on resume optimization and job search strategies.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 rounded-lg bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
              />
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Resumify. All rights reserved. Built with ❤️ for job seekers.
            </div>
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              ...
              <span>Made with React Router v7</span>
            </div>
          </div>
        </div>
      </div>
